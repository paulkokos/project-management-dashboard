...
describe('MilestoneProgress Component - Extended Coverage', () => {
  describe('Rendering', () => {
    it('should render without crashing with valid props', () => {
      const { container } = render(
        <MilestoneProgress milestoneCount={5} completedMilestoneCount={3} />
      );
    ...
    it('should display milestone count', () => {
      render(<MilestoneProgress milestoneCount={5} completedMilestoneCount={3} />);
  ...
  describe('Null and undefined handling', () => {
    it('should return null when milestoneCount is null', () => {
      const { container } = render(
        <MilestoneProgress milestoneCount={null} completedMilestoneCount={3} />
      );
    ...
    it('should return null when milestoneCount is undefined', () => {
      const { container } = render(
        <MilestoneProgress milestoneCount={undefined} completedMilestoneCount={3} />
      );
    ...
    it('should return null when completedMilestoneCount is null', () => {
      const { container } = render(
        <MilestoneProgress milestoneCount={5} completedMilestoneCount={null} />
      );
    ...
    it('should return null when completedMilestoneCount is undefined', () => {
      const { container } = render(
        <MilestoneProgress milestoneCount={5} completedMilestoneCount={undefined} />
      );
    ...
    it('should return null when both are null', () => {
      const { container } = render(
        <MilestoneProgress milestoneCount={null} completedMilestoneCount={null} />
      );
    ...
    it('should return null when both are undefined', () => {
      const { container } = render(
        <MilestoneProgress milestoneCount={undefined} completedMilestoneCount={undefined} />
      );
  ...
  describe('Zero milestones state', () => {
    it('should display "No milestones" when count is 0', () => {
      render(<MilestoneProgress milestoneCount={0} completedMilestoneCount={0} />);
    ...
    it('should not display progress bar when count is 0', () => {
      const { container } = render(
        <MilestoneProgress milestoneCount={0} completedMilestoneCount={0} />
      );
  ...
  describe('Different completion percentages', () => {
    it('should render 0% completion (0/10)', () => {
      render(<MilestoneProgress milestoneCount={10} completedMilestoneCount={0} />);

      expect(screen.getByText('0/10')).toBeInTheDocument();

      const { container } = render(
        <MilestoneProgress milestoneCount={10} completedMilestoneCount={0} />
      );
    ...
    it('should render 50% completion (5/10)', () => {
      render(<MilestoneProgress milestoneCount={10} completedMilestoneCount={5} />);

      expect(screen.getByText('5/10')).toBeInTheDocument();

      const { container } = render(
        <MilestoneProgress milestoneCount={10} completedMilestoneCount={5} />
      );
    ...
    it('should render 100% completion (10/10)', () => {
      render(<MilestoneProgress milestoneCount={10} completedMilestoneCount={10} />);

      expect(screen.getByText('10/10')).toBeInTheDocument();

      const { container } = render(
        <MilestoneProgress milestoneCount={10} completedMilestoneCount={10} />
      );
    ...
    it('should render 25% completion (1/4)', () => {
      render(<MilestoneProgress milestoneCount={4} completedMilestoneCount={1} />);

      expect(screen.getByText('1/4')).toBeInTheDocument();

      const { container } = render(
        <MilestoneProgress milestoneCount={4} completedMilestoneCount={1} />
      );
    ...
    it('should render 75% completion (3/4)', () => {
      render(<MilestoneProgress milestoneCount={4} completedMilestoneCount={3} />);

      expect(screen.getByText('3/4')).toBeInTheDocument();

      const { container } = render(
        <MilestoneProgress milestoneCount={4} completedMilestoneCount={3} />
      );
    ...
    it('should round percentage correctly (1/3 = 33%)', () => {
      const { container } = render(
        <MilestoneProgress milestoneCount={3} completedMilestoneCount={1} />
      );
    ...
    it('should round percentage correctly (2/3 = 67%)', () => {
      const { container } = render(
        <MilestoneProgress milestoneCount={3} completedMilestoneCount={2} />
      );
  ...
  describe('Progress bar width calculation', () => {
    it('should calculate correct width for various percentages', () => {
      ...
      testCases.forEach(({ total, completed, expected }) => {
        const { container } = render(
          <MilestoneProgress milestoneCount={total} completedMilestoneCount={completed} />
        );
  ...
  describe('Edge cases', () => {
    it('should handle single milestone (1/1)', () => {
      render(<MilestoneProgress milestoneCount={1} completedMilestoneCount={1} />);

      expect(screen.getByText('1/1')).toBeInTheDocument();
    });

    it('should handle single incomplete milestone (0/1)', () => {
      render(<MilestoneProgress milestoneCount={1} completedMilestoneCount={0} />);

      expect(screen.getByText('0/1')).toBeInTheDocument();
    });

    it('should handle large milestone count', () => {
      render(<MilestoneProgress milestoneCount={1000} completedMilestoneCount={500} />);
    ...
    it('should handle completed count exceeding total (edge case)', () => {
      ...
      render(<MilestoneProgress milestoneCount={5} completedMilestoneCount={7} />);

      expect(screen.getByText('7/5')).toBeInTheDocument();

      const { container } = render(
        <MilestoneProgress milestoneCount={5} completedMilestoneCount={7} />
      );
  ...
  describe('Component integration', () => {
    it('should work with different milestone counts', () => {
      ...
      milestones.forEach(({ total, completed }) => {
        render(<MilestoneProgress milestoneCount={total} completedMilestoneCount={completed} />);
