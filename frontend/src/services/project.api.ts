...
export const projectAPI = {
  ...
  patch: (id: number, data: Record<string, unknown>) => api.patch(`/projects/${id}/`, data),
  delete: (id: number) => api.delete(`/projects/${id}/`),
  softDelete: (id: number) => api.post(`/projects/${id}/soft_delete/`),
  restore: (id: number) => api.post(`/projects/${id}/restore/`),
  deleted: () => api.get('/projects/deleted/'),
  emptyTrash: () => api.post('/projects/empty_trash/'),
  activities: (id: number) => api.get(`/projects/${id}/activities/`),
